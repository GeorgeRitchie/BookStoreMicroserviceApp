...
namespace Service.CatalogWrite.Domain.Publishers
{
	...
	{
		public static readonly PublisherImageType ProfileIcon = new("ProfileIcon", 0);
		public static readonly PublisherImageType AuthorPhoto = new("AuthorPhoto", 1);
		public static readonly PublisherImageType Other = new("Other", 2);
