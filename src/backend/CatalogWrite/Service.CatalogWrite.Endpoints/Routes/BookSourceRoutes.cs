...
{
	/// <summary>
	/// Contains values used for book source endpoints routing stuff.
	/// </summary>
	internal static class BookSourceRoutes
	{
		internal const string Tag = "BookSources";

		internal const string BaseUri = "api/v{version:apiVersion}/booksources";
