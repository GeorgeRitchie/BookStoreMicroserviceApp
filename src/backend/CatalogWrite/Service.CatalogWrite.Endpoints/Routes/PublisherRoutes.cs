...
{
	/// <summary>
	/// Contains values used for publisher endpoints routing stuff.
	/// </summary>
	internal static class PublisherRoutes
	{
		internal const string Tag = "Publishers";

		internal const string BaseUri = "api/v{version:apiVersion}/publishers";
