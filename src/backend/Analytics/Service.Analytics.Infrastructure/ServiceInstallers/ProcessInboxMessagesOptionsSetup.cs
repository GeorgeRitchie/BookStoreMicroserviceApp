...
using Service.Analytics.Infrastructure.BackgroundJobs.ProcessInboxMessages;
...
namespace Service.Analytics.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Analytics:BackgroundJobs:ProcessInboxMessages";
