...
namespace Service.Analytics.WebApi.ServiceInstallers.EventBus
{
	/// <summary>
	...
	internal sealed class EventBusServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration) =>
			services
				...
				{
					busConfigurator.SetEndpointNameFormatter(new KebabCaseEndpointNameFormatter(prefix: nameof(Analytics), includeNamespace: false));
