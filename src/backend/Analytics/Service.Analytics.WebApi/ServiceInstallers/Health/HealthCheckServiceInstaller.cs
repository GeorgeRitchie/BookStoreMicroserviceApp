...
using Service.Analytics.WebApi.ServiceInstallers.DistributedCaching;
using Service.Analytics.WebApi.ServiceInstallers.EventBus;

namespace Service.Analytics.WebApi.ServiceInstallers.Health
{
	/// <summary>
	...
	internal sealed class HealthCheckServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration)
		{
			...
			healthCheckBuilder.AddDbContextCheck<AnalyticsDbContext>();
