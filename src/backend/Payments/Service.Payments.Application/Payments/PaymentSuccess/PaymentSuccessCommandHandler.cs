...
namespace Service.Payments.Application.Payments.PaymentSuccess
{
	/// <summary>
	/// Represents the <see cref="PaymentSuccessCommand"/> handler.
	/// </summary>
	/// <remarks>
	/// Initializes a new instance of the <see cref="PaymentSuccessCommandHandler"/> class.
	/// </remarks>
	/// <param name="db">The database.</param>
	/// <param name="repository">The payment repository.</param>
	/// <param name="eventBus">The event bus.</param>
	internal sealed class PaymentSuccessCommandHandler(
		IPaymentDb db,
		IPaymentRepository repository,
		IEventBus eventBus)
		: ICommandHandler<PaymentSuccessCommand>
	{
		/// <inheritdoc/>
		public async Task<Result> Handle(PaymentSuccessCommand request, CancellationToken cancellationToken)
			=> await Result.Create(
