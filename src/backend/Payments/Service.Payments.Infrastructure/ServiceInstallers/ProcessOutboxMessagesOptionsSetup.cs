...
using Service.Payments.Infrastructure.BackgroundJobs.ProcessOutboxMessages;
...
namespace Service.Payments.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Payment:BackgroundJobs:ProcessOutboxMessages";
