...
using PaymentApplication = Service.Payments.Application;

namespace Service.Payments.Infrastructure.ServiceInstallers
{
	/// <summary>
	/// Represents the Payment service application layer service installer.
	/// </summary>
	internal sealed class ApplicationServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration) =>
			services
				.AddMediatR(cfg => cfg.RegisterServicesFromAssemblies(PaymentApplication.AssemblyReference.Assembly))
				...
				.AddValidatorsFromAssembly(
					PaymentApplication.AssemblyReference.Assembly,
				...
				.AddAutoMapper(config => config.AddProfile(new AssemblyMappingProfile(PaymentApplication.AssemblyReference.Assembly)))
