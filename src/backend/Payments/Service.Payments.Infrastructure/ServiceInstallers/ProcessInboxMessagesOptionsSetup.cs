...
using Service.Payments.Infrastructure.BackgroundJobs.ProcessInboxMessages;
...
namespace Service.Payments.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Payment:BackgroundJobs:ProcessInboxMessages";
