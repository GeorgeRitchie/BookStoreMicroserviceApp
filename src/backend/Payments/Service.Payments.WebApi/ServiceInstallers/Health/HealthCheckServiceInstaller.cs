...
using Service.Payments.WebApi.ServiceInstallers.DistributedCaching;
using Service.Payments.WebApi.ServiceInstallers.EventBus;

namespace Service.Payments.WebApi.ServiceInstallers.Health
{
	/// <summary>
	...
	internal sealed class HealthCheckServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration)
		{
			...
			healthCheckBuilder.AddDbContextCheck<PaymentDbContext>();
