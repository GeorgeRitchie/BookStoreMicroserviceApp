...
using Service.Payments.WebApi.Extensions;
using Service.Payments.WebApi.Middlewares;
using Service.Payments.WebApi.Options;
using Service.Payments.WebApi.Utility;
...
LoggingUtility.Run(() =>
{
	...
	builder.Services
		...
		.InstallServicesFromAssemblies(
			...
			Service.Payments.WebApi.AssemblyReference.Assembly,
			Authorization.AssemblyReference.Assembly,
			Persistence.AssemblyReference.Assembly)
		.InstallModulesFromAssemblies(
				builder.Configuration,
				Service.Payments.Infrastructure.AssemblyReference.Assembly);
	...
	{
		var applicationDbContext = webApplication.Services.CreateScope().ServiceProvider.GetRequiredService<PaymentDbContext>();
