...
using CartApplication = Service.Carts.Application;

namespace Service.Carts.Infrastructure.ServiceInstallers
{
	/// <summary>
	/// Represents the Cart service application layer service installer.
	/// </summary>
	internal sealed class ApplicationServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration) =>
			services
				.AddMediatR(cfg => cfg.RegisterServicesFromAssemblies(CartApplication.AssemblyReference.Assembly))
				...
				.AddValidatorsFromAssembly(
					CartApplication.AssemblyReference.Assembly,
				...
				.AddAutoMapper(config => config.AddProfile(new AssemblyMappingProfile(CartApplication.AssemblyReference.Assembly)))
