...
using Service.Carts.Infrastructure.BackgroundJobs.ProcessInboxMessages;
...
namespace Service.Carts.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Cart:BackgroundJobs:ProcessInboxMessages";
