...
using Service.Carts.Infrastructure.BackgroundJobs.ProcessOutboxMessages;
...
namespace Service.Carts.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Cart:BackgroundJobs:ProcessOutboxMessages";
