...
using ShipmentApplication = Service.Shipments.Application;

namespace Service.Shipments.Infrastructure.ServiceInstallers
{
	/// <summary>
	/// Represents the Shipment service application layer service installer.
	/// </summary>
	internal sealed class ApplicationServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration) =>
			services
				.AddMediatR(cfg => cfg.RegisterServicesFromAssemblies(ShipmentApplication.AssemblyReference.Assembly))
				...
				.AddValidatorsFromAssembly(
					ShipmentApplication.AssemblyReference.Assembly,
				...
				.AddAutoMapper(config => config.AddProfile(new AssemblyMappingProfile(ShipmentApplication.AssemblyReference.Assembly)))
