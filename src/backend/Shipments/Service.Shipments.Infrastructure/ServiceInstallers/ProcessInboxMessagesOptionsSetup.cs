...
using Service.Shipments.Infrastructure.BackgroundJobs.ProcessInboxMessages;
...
namespace Service.Shipments.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Shipment:BackgroundJobs:ProcessInboxMessages";
