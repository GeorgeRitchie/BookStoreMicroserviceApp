...
using Service.Shipments.Infrastructure.BackgroundJobs.ProcessOutboxMessages;
...
namespace Service.Shipments.Infrastructure.ServiceInstallers
{
	...
	{
		private const string ConfigurationSectionName = "Service:Shipment:BackgroundJobs:ProcessOutboxMessages";
