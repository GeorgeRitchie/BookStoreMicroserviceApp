...
namespace Service.Shipments.WebApi.ServiceInstallers.EventBus
{
	/// <summary>
	...
	internal sealed class EventBusServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration) =>
			services
				...
				{
					busConfigurator.SetEndpointNameFormatter(new KebabCaseEndpointNameFormatter(prefix: nameof(Shipments), includeNamespace: false));
