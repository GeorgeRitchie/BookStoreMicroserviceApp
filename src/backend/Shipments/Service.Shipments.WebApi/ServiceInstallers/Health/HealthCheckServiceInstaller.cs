...
using Service.Shipments.WebApi.ServiceInstallers.DistributedCaching;
using Service.Shipments.WebApi.ServiceInstallers.EventBus;

namespace Service.Shipments.WebApi.ServiceInstallers.Health
{
	/// <summary>
	...
	internal sealed class HealthCheckServiceInstaller : IServiceInstaller
	{
		...
		public void Install(IServiceCollection services, IConfiguration configuration)
		{
			...
			healthCheckBuilder.AddDbContextCheck<ShipmentDbContext>();
