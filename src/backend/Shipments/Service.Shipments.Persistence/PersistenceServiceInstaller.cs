...
{
	/// <summary>
	/// Represents the Shipment module persistence service installer.
	/// </summary>
			...
			=> services.AddDbContext<ShipmentDbContext>((serviceProvider, options) =>
			{
				...
				options
					.UseSqlServer(
						...
						dbContextOptionsBuilder => dbContextOptionsBuilder.WithMigrationHistoryTableInSchema(Schemas.Shipment))
				...
				.AddScoped<IRepository<InboxMessageConsumer, Guid>, Repository<InboxMessageConsumer, Guid, ShipmentDbContext>>();
	}
}
