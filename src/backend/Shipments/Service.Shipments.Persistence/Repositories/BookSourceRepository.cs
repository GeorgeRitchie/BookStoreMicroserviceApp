...
namespace Service.Shipments.Persistence.Repositories
{
	...
	internal sealed class BookSourceRepository(ShipmentDbContext context)
		: Repository<BookSource, BookSourceId, ShipmentDbContext>(context), IBookSourceRepository
	{
	}
}
