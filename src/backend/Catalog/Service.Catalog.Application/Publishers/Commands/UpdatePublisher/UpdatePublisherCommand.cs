...
namespace Service.Catalog.Application.Publishers.Commands.UpdatePublisher
{
	/// <summary>
	/// Represents the command for updating the specified publisher.
	/// </summary>
	public sealed class UpdatePublisherCommand : ICommand
	{
		/// <summary>
