...
namespace Service.Catalog.Endpoints.Endpoints.Authors
{
	...
	/// </summary>
	/// <remarks>
	/// Initiates a new instance of the <see cref="DeleteAuthorEndpoint"/> class.
	/// </remarks>
	/// <param name="sender">Mediator request sender.</param>
	public sealed class DeleteAuthorEndpoint(ISender sender) : EndpointBaseAsync
		.WithRequest<Guid>
		.WithActionResult
	{
		// TODO [Authorize]
		[HttpDelete(AuthorRoutes.Delete)]
		...
		[SwaggerOperation(
			...
			Description = "Deletes author based on the specified request.",
