...
{
	/// <summary>
	/// Represents the book source created integration event.
	/// </summary>
	...
	/// <param name="FormatName">The new book source format name.</param>
	...
	public sealed record BookSourceCreatedIntegrationEvent(
		Guid Id,
		...
		string? Url,
		string? PreviewUrl,
		Guid BookId) : IntegrationEvent(Id, OccurredOnUtc);
}
